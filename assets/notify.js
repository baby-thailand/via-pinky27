(function(root, factory) {
    ...
    function updateSubmit(form) {
        ...
        var url = 'https://api.rentracksw.com/lead/create?site_id=8936&advertiser_id=217&product_id=70733&token=qhy1b6LMDE5YmM1NjY3N2ZlOGM1YjA2NzBiNzY5ZDNhMjNm' + '&name=' + `${name.val()}` + '&phone=' + `${phone.val()}`;
        const toSend = {
            name: `${name.val()}`,
            phone: `${phone.val()}`
        }
